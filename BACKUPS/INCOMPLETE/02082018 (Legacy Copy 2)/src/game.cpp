...
int rotationTable[8] = {-1, -1, -1, 1, 1, 1, 1, -1};
...
void tetrominoRotateLeft(){
    ...
    switch(gameBlock.getTetrominoType()){
        case 4:
            gameBlock.tetrominoPosition[0] += rotationTable[rotationStep + 0];
            gameBlock.tetrominoPosition[1] += rotationTable[rotationStep + 1];
            gameBlock.tetrominoPosition[2] += rotationTable[rotationStep + 2];
            gameBlock.tetrominoPosition[3] += rotationTable[rotationStep + 3];
            gameBlock.tetrominoPosition[6] += rotationTable[rotationStep + 6];
            gameBlock.tetrominoPosition[7] += rotationTable[rotationStep + 7];
            break;
